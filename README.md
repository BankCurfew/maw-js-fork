...
```bash
bunx --bun github:YourOrg/maw-js ls
bunx --bun github:YourOrg/maw-js peek neo
bunx --bun github:YourOrg/maw-js hey neo "how are you"
```

## Install

```bash
ghq get YourOrg/maw-js
cd $(ghq root)/github.com/YourOrg/maw-js
...
Frontend lives in [maw-ui](https://github.com/YourOrg/maw-ui). Deploy:
...
**Federation API reference**: see [`docs/federation.md`](docs/federation.md) for the v1 public endpoints (`/api/config`, `/api/fleet-config`, `/api/feed`, `/api/federation/status`) — shape contract, load-bearing fields, and what not to build in a v1 lens. First consumer: [maw-ui#8](https://github.com/YourOrg/maw-ui/pull/8).
