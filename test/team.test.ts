...
describe("cmdTeamList", () => {
  ...
  test.skip("lists teams with member counts (needs tmux mock)", async () => {
...
describe("cmdCleanupZombies", () => {
  test.skip("runs without error and produces output (needs tmux mock)", async () => {
  ...
  test.skip("does not kill panes without --yes (needs tmux mock)", async () => {
