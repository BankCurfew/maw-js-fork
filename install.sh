...
#   bun add -g github:YourOrg/maw-js#alpha       # persistent
#   bunx --bun github:YourOrg/maw-js#alpha ...   # zero-install, one-shot
#
# Env overrides:
...
while [ $# -gt 0 ]; do
  case "$1" in
    ...
    --help|-h)
      ...
      echo "  bun add -g github:YourOrg/maw-js#alpha    # persistent"
      echo "  bunx --bun github:YourOrg/maw-js#alpha .. # zero-install"
      exit 0 ;;
    -*)
