...
import { HealthCheckWidget } from "./pages/widgets/HealthCheckWidget";
...
export function App() {
  ...
  if (route === "comms") {
    return (
      <Layout activeView="comms" {...layoutProps} fullHeight>
        <CommsView />
      </Layout>
    );
  }
  ...
  if (route === "voice") {
    return (
      <Layout activeView="voice" {...layoutProps}>
        <VoiceView />
      </Layout>
    );
  }
  ...
  if (route === "heartbeats") {
    return (
      <Layout activeView="heartbeats" {...layoutProps}>
        <div className="mx-2 sm:mx-4 md:mx-6 my-4 max-w-3xl space-y-4">
          <HealthCheckWidget />
          <HeartbeatsWidget />
        </div>
      </Layout>
