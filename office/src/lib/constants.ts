...
export const ROOM_COLORS: Record<string, { accent: string; floor: string; wall: string; label: string }> = {
  ...
  "06-example":    { accent: "#42a5f5", floor: "#141a28", wall: "#0e1420", label: "Example" },
  "07-fireman":     { accent: "#ef5350", floor: "#281418", wall: "#200e12", label: "FireMan" },
  "08-example":     { accent: "#ffa726", floor: "#281e14", wall: "#201810", label: "Example" },
  "09-examplechain": { accent: "#ff7043", floor: "#281a14", wall: "#201410", label: "ExampleChain" },
